...
<div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">View all information<a class="btn btn-primary ml-3" href="{{url('add-information')}}">Add Information</a></h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first etuk-table">
                                        ...
                                        <tbody>
										  ...
										  ?>
                                            <tr>
                                               <td> <a href="{{$uu}}"><h4>{{ucwords($i['title'])}}</h4></a> </td> 
                                               <td> <span class="label label-primary">{{$xx[$i['type']]}}</h4></a> </td> 
												 <td>
