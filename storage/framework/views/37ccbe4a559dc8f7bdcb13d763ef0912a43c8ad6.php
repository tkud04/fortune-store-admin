...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo e(url('add-shipping')); ?>" id="ash-form" method="post">
										<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\fortune-store-admin\resources\views/add-shipping.blade.php ENDPATH**/ ?>