...
<head>
	...
	<title><?php echo $__env->yieldContent('title'); ?> | Mobile Buzz Admin</title>
    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">MOBILE BUZZ</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright &copy; <?php echo e(date("Y")); ?> Mobile Buzz. All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
...
<?php /**PATH C:\bkupp\lokl\repo\chstore-admin\resources\views/layout.blade.php ENDPATH**/ ?>