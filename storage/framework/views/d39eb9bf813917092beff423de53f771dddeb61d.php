...
<div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">View Gallery<a class="btn btn-primary ml-3" href="<?php echo e(url('add-gallery')); ?>">Add to Gallery</a></h5>
                            <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\fortune-store-admin\resources\views/gallery.blade.php ENDPATH**/ ?>