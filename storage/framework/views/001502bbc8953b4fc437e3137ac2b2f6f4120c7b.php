...
<head>
	...
	<title><?php echo $__env->yieldContent('title'); ?> | Luxfabriqs Admin</title>
    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">LUXFABRIQS</a>
...
<?php /**PATH C:\bkupp\lokl\repo\fortune-store-admin\resources\views/layout.blade.php ENDPATH**/ ?>