...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo e(url('add-information')); ?>" id="add-information-form" method="post" enctype="multipart/form-data">
										<?php echo csrf_field(); ?>
										...
										<div class="form-group">
                                            ...
                                            <input id="add-information-title" type="text" name="title" placeholder="Title" class="form-control">
                                        </div>
										</div>
										<div class="col-md-12">
										<div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 pl-0">
                                                <p class="text-right">
                                                    <button class="btn btn-space btn-secondary" id="add-information-submit">Submit</button>
                                                </p>
                                            </div>
                                        </div>
                                    </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\chstore-admin\resources\views/add-information.blade.php ENDPATH**/ ?>