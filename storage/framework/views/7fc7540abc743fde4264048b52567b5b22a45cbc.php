...
<div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">View all information<a class="btn btn-primary ml-3" href="<?php echo e(url('add-information')); ?>">Add Information</a></h5>
										  ...
										  <?php
										   if(count($information) > 0)
										   {
											  foreach($information as $i)
											   {
											     $uu = url('edit-information')."?xf=".$i['id'];  
											     $dr = url('remove-information')."?xf=".$i['id'];  
										  ?>
                                            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\bkupp\lokl\repo\chstore-admin\resources\views/information.blade.php ENDPATH**/ ?>